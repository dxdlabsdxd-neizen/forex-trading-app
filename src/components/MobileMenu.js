...
const MobileMenu = ({ onNavigate, currentPage, onOpenDepositModal }) => {
  ...
  const [activeTopNavItem, setActiveTopNavItem] = useState('Menu') // Track active top navigation item
  const [currentModal, setCurrentModal] = useState('Market') // Show Market page by default
  ...
  const handleMenuClick = () => {
    setActiveTopNavItem('Menu') // Set Menu as active
      ...
      {currentModal !== 'History' && currentModal !== 'Positions' && currentModal !== 'Market' && currentModal !== 'Withdrawal' && currentModal !== 'Deposit' && (
        <div className="mobile-header">
          ...
          <div className="mobile-button-group">
            <div className={`mobile-menu-btn ${activeTopNavItem === 'Menu' ? 'active' : ''}`} onClick={handleMenuClick}>
            ...
            <div className={`mobile-menu-btn ${activeTopNavItem === 'Deposit' ? 'active' : ''}`} onClick={() => handleNavClick('Deposit')}>
              <div className="mobile-btn-icon">
            ...
            <div className={`mobile-menu-btn ${activeTopNavItem === 'Trade' ? 'active' : ''}`} onClick={handleTradeClick}>
              <div className="mobile-btn-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
