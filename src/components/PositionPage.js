...
const PositionPage = ({ onClose, onNavigateToHistory }) => {
  ...
  const currentData = activeTab === 'Position' ? openPositionsData : orderData

  return (
    <div className="position-page-container">
      {/* Header Section */}
      ...
      {/* Main Content */}
      <div className="position-main-content">
        {/* Tab Section */}
        ...
        <div className="position-table-container">
          <div className="table-header">
            <div className="header-row">
              ...
              <div className="header-cell price">
                <p>Price</p>
              </div>
              ...
              <div className="header-cell profit">
                <p>{activeTab === 'Position' ? 'P&L' : 'Volume'}</p>
              </div>
              <div className="header-cell close-all">
                <p>CLOSE ALL</p>
              </div>
            </div>
          </div>
          ...
          <div className="table-body">
            {currentData.map((position, index) => (
              <div key={index} className="table-row clickable-row" onClick={() => handlePositionClick(position)}>
                <div className="table-cell symbol">
                  <p>{position.symbol}</p>
                </div>
                <div className="table-cell type">
                  <p className={position.type.toLowerCase()}>{position.type}</p>
                </div>
                <div className="table-cell price">
                  <p>{position.currentPrice || position.closePrice}</p>
                </div>
                <div className="table-cell enter-price">
                  <p>{position.openPrice}</p>
                </div>
                <div className="table-cell profit">
                  <p className={activeTab === 'Position' && position.isProfit ? 'profit-positive' : activeTab === 'Position' && !position.isProfit ? 'profit-negative' : ''}>
                    {activeTab === 'Position' ? position.profit : (position.volume || '0.1')}
                  </p>
                </div>
                <div className="table-cell close-all">
      ...
      <div className="position-bottom-nav">
        <div className="nav-item">
          <div className="nav-icon">
            <svg width="22" height="13" viewBox="0 0 22 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M22 0.557739V6.50696C22 6.65488 21.9367 6.79674 21.8241 6.90134C21.7115 7.00593 21.5588 7.0647 21.3996 7.0647C21.2404 7.0647 21.0876 7.00593 20.975 6.90134C20.8624 6.79674 20.7992 6.65488 20.7992 6.50696V1.90375L12.2173 9.8757C12.1048 9.98015 11.9522 10.0388 11.7931 10.0388C11.6339 10.0388 11.4813 9.98015 11.3688 9.8757L7.79033 6.55251L1.00972 12.8503C0.895903 12.9488 0.745363 13.0025 0.589817 12.9999C0.43427 12.9974 0.285861 12.9388 0.175856 12.8366C0.0658504 12.7345 0.00283798 12.5966 9.35412e-05 12.4521C-0.0026509 12.3076 0.0550869 12.1678 0.161143 12.062L7.36604 5.36917C7.47862 5.26472 7.63122 5.20606 7.79033 5.20606C7.94944 5.20606 8.10204 5.26472 8.21462 5.36917L11.7931 8.69236L19.9506 1.11548H14.9952C14.836 1.11548 14.6833 1.05672 14.5707 0.95212C14.4581 0.847524 14.3948 0.705661 14.3948 0.557739C14.3948 0.409817 14.4581 0.267954 14.5707 0.163358C14.6833 0.0587616 14.836 0 14.9952 0H21.3996C21.5588 0 21.7115 0.0587616 21.8241 0.163358C21.9367 0.267954 22 0.409817 22 0.557739Z" fill="white"/>
            </svg>
          </div>
        ...
        <div className="nav-item" onClick={() => onNavigateToHistory ? onNavigateToHistory() : onClose()}>
          <div className="nav-icon">
          ...
          >
            ...
            <div className="modal-body">
              {activeTab === 'Position' ? (
                ...
                <>
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <p>{selectedPosition.openPrice}</p>
                    </div>
                  </div>
                  ...
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <p>{selectedPosition.currentPrice || selectedPosition.closePrice}</p>
                    </div>
                  </div>
                  ...
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <p>{selectedPosition.commission}</p>
                    </div>
                  </div>
                  ...
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <p style={{ color: selectedPosition.type === 'Buy' ? '#1bb507' : '#e14145' }}>
                  ...
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <p style={{ color: selectedPosition.profit.startsWith('+') ? '#1bb507' : '#e14145' }}>
                  ...
                  <div className="modal-field">
                    ...
                    <div className="field-value">
                      <div style={{ textAlign: 'right' }}>
                        <p>{selectedPosition.created}</p>
                        <p>{selectedPosition.createdTime}</p>
                      </div>
                    </div>
                  </div>
                ...
                // Order Modal Content
                <>
                  <div className="modal-field input-field">
                    <div className="field-label">
                      <p>Enter Price</p>
                    </div>
                    <div className="field-value input-value">
                      <input 
                        type="text" 
                        value="0.65419" 
                      ...
                      <div className="input-arrows">
                        <button className="arrow-btn up-arrow">
                          <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 8 L8 2 L14 8" stroke="#1e1e1e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                        </button>
                        <button className="arrow-btn down-arrow">
                          <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 2 L8 8 L14 2" stroke="#1e1e1e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                        </button>
                      </div>
                    </div>
           ...
           <div className="field-label">
             <div className="checkbox-container">
               <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <rect x="0.5" width="14" height="14" rx="7" fill="#767676"/>
               </svg>
               <p>Take Profit</p>
             </div>
           </div>
