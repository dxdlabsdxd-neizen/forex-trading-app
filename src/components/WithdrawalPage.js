...
const WithdrawalPage = ({ onClose, onNavigateToMenu, onNavigateToDeposit, onNavigateToTrade, onNavigateToMarket, onNavigateToChart, onNavigateToPositions, onNavigateToHistory }) => {
  ...
  return (
    <div className="withdrawal-page-container">
      {/* Header Background */}
      <div className="withdrawal-header-bg">
        <div className="withdrawal-header-shadow"></div>
      </div>

      {/* Main Content */}
      <div className="withdrawal-main-content">
        {/* Equity Section */}
        <div className="withdrawal-equity-section">
          <div className="withdrawal-equity-label">Equity</div>
          <div className="withdrawal-equity-value">$10,000.00</div>
        </div>

        {/* Main Menu Buttons */}
        <div className="withdrawal-menu-buttons">
          <div className="withdrawal-menu-button" onClick={handleMenuClick}>
            <div className="withdrawal-menu-icon-box">
            ...
            <div className="withdrawal-menu-text">Menu</div>
          </div>
          <div className="withdrawal-menu-button" onClick={handleDepositClick}>
            <div className="withdrawal-menu-icon-box">
            ...
            <div className="withdrawal-menu-text">Deposit</div>
          </div>
          <div className="withdrawal-menu-button" onClick={handleTradeClick}>
            <div className="withdrawal-menu-icon-box">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="withdrawal-menu-text">Trade</div>
          </div>
        </div>

        {/* Tab Section - Bank and Crypto */}
        <div className="mobile-withdrawal-tab-section">
          <button 
            className={`mobile-withdrawal-tab ${withdrawalMethod === 'bank' ? 'active' : ''}`}
            onClick={() => handleWithdrawalMethodChange('bank')}
          >
            Bank
          </button>
          <button 
            className={`mobile-withdrawal-tab ${withdrawalMethod === 'crypto' ? 'active' : ''}`}
        ...
        {/* Withdrawal Content - Middle Section */}
        <div className="withdrawal-content-wrapper">
          {withdrawalPage === 1 && (
            <div className="withdrawal-box">
              <div className="withdrawal-info-header">
                <h3 className="withdrawal-info-title">Withdrawal Information</h3>
                <p className="withdrawal-info-subtitle">Please enter the amount you wish to deposit:</p>
              </div>

              <div className="withdrawal-form-section">
                <label className="withdrawal-form-label">Amount to be deposited (USD)</label>
              ...
              <div className="withdrawal-quick-selection">
                <span className="withdrawal-quick-selection-label">Quick Amount Selection</span>
              ...
              <div className="withdrawal-summary-section">
                <div className="withdrawal-summary-row">
                  <span className="withdrawal-summary-label">Amount to be sent:</span>
              ...
              <button className="withdrawal-button" onClick={handleWithdrawClick}>
                Withdraw
              </button>
            </div>
          )}
          ...
          {withdrawalPage === 2 && (
            <div className="withdrawal-info-container">
              {/* Bank Transfer Form */}
              {withdrawalMethod === 'bank' && (
                <div className="withdrawal-info-box">
                  {/* Header with back button */}
                  <div className="withdrawal-info-box-header">
                    <button className="withdrawal-back-button" onClick={() => setWithdrawalPage(1)}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 18L9 12L15 6" stroke="#1D6CE9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </button>
                    <div className="withdrawal-info-box-title-section">
                      <h3 className="withdrawal-info-box-title">Bank Transfer Information</h3>
                      <p className="withdrawal-info-box-subtitle">Please enter your bank details for withdrawal</p>
                    </div>
                  </div>
                  
                  {/* Bank Input Fields */}
                  <div className="withdrawal-form-inputs">
                    <div className="withdrawal-input-field">
                    ...
                    <div className="withdrawal-input-field">
                      <label className="withdrawal-form-label">Account Holder Name</label>
                      <input type="text" placeholder="Dutch Bank LTD" className="withdrawal-sub-input" />
                    </div>
                    <div className="withdrawal-input-field">
                      <label className="withdrawal-form-label">IBAN Address</label>
                      <input type="text" placeholder="9012 3456 78" className="withdrawal-sub-input" />
                    </div>
                  </div>

                  {/* Important Notes */}
                  <div className="withdrawal-important-notes">
                    <div className="withdrawal-notes-header" onClick={() => setIsNotesExpanded(!isNotesExpanded)}>
                      <h4 className="withdrawal-notes-title">Important Notes</h4>
                      <svg 
                        className={`withdrawal-notes-toggle-arrow ${isNotesExpanded ? 'expanded' : ''}`}
                        width="12" 
                        height="12" 
                        viewBox="0 0 24 24" 
                        fill="none"
                      >
                        <path d="M6 9l6 6 6-6" stroke="#8a6d3b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    {isNotesExpanded && (
                      <ul className="withdrawal-notes-list">
              ...
              {withdrawalMethod === 'crypto' && (
                <div className="withdrawal-info-box">
                  ...
                  <div className="withdrawal-info-box-header">
                    ...
                    <div className="withdrawal-info-box-title-section">
                      <h3 className="withdrawal-info-box-title">Cryptocurrency Withdrawal</h3>
                      <p className="withdrawal-info-box-subtitle">Please enter your crypto withdrawal details</p>
                    </div>
                  </div>
                  ...
                  <div className="withdrawal-form-inputs">
                    <div className="withdrawal-input-field">
                      ...
                      <div className="withdrawal-select-group">
                    ...
                    <div className="withdrawal-input-field">
                      <label className="withdrawal-form-label">Network Address</label>
                      <div className="withdrawal-select-group">
                        <div className="withdrawal-select-content">
                    ...
                    <div className="withdrawal-input-field">
                      <label className="withdrawal-form-label">Withdrawal Address</label>
      ...
      <div className="figma-bottom-nav">
        ...
        <div className="figma-nav-item" onClick={handlePositionsClick}>
          <div className="figma-nav-icon-container">
            <div className="figma-nav-icon">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
