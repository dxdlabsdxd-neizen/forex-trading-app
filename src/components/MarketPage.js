...
const MarketPage = ({ onNavigateToHistory, onNavigateToPositions, onNavigateToChart, onNavigateToMenu, onNavigateToDeposit, onNavigateToTrade }) => {
  ...
  const firstRowCategories = ['All', 'Watchlist', 'Endex'];
  const secondRowCategories = ['Exchange', 'Commodity', 'Stock'];
  ...
  // Handle symbol row click - Exact copy from History Page
  ...
  // Handle modal close - Exact copy from History Page
  ...
  // Handle drag start - Exact copy from History Page
  ...
  // Handle drag move - Exact copy from History Page
  ...
  // Handle drag end - Exact copy from History Page
  const handleDragEnd = () => {
    setIsDragging(false)
  }

  // Add event listeners for drag - Exact copy from History Page
  React.useEffect(() => {
    if (isDragging) {
  ...
  const handleCreateOrderClick = () => {
    handleModalClose()
    // Add create order functionality here
    console.log('Create Order clicked for:', selectedSymbol)
  }

  const handleAddWatchlistClick = () => {
    handleModalClose()
    // Add watchlist functionality here
    console.log('Add to Watchlist clicked for:', selectedSymbol)
  }
  ...
  return (
    <div className="market-page-container">
      ...
      <div className="market-header-bg">
        <div className="market-header-shadow"></div>
      </div>
      ...
      <div className="market-main-content">
        ...
        <div className="equity-section">
          ...
          <div className="equity-value">$10,000.00</div>
        </div>
         ...
         <div className="main-menu-buttons">
           ...
           <div className="menu-button" onClick={handleDepositClick}>
             <div className="menu-icon-box">
           ...
           <div className="menu-button" onClick={handleTradeClick}>
             <div className="menu-icon-box">
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="market-data-section">
          ...
          {/* Market Data Rows */}
           <div className="market-data-rows">
             {marketData.map((item, index) => (
               <div key={index} className="market-data-row" onClick={() => handleSymbolClick(item.symbol)}>
                <div className="symbol-section">
                  <img src={item.logo} alt={item.symbol} className="symbol-logo" />
                ...
                <div className="change-section">
                  <div className="change-value" style={{ color: item.changeColor }}>
                    {item.change}
                  </div>
                </div>
              </div>
      ...
      <div className="figma-bottom-nav">
       ...
       {/* Symbol Modal - Exact copy from History Page */}
       {showModal && selectedSymbol && (
         <div className="modal-overlay" onClick={handleModalClose}>
           ...
           >
             ...
             {/* Modal Body - Buttons instead of fields */}
             <div className="modal-body">
               <div className="modal-field">
                 <button className="symbol-modal-button" onClick={handleChartModalClick}>
                   Chart
                 </button>
               </div>
               
               <div className="modal-field">
                 <button className="symbol-modal-button" onClick={handleCreateOrderClick}>
                   Create Order
                 </button>
               </div>
               
               <div className="modal-field">
                 <button className="symbol-modal-button" onClick={handleAddWatchlistClick}>
                   Add Watchlist
                 </button>
               </div>
             </div>
