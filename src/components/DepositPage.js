...
const DepositPage = ({ onClose, onNavigateToMenu, onNavigateToWithdrawal, onNavigateToTrade, onNavigateToMarket, onNavigateToChart, onNavigateToPositions, onNavigateToHistory }) => {
  ...
  return (
    <div className="deposit-page-container">
      {/* Header Background */}
      <div className="deposit-header-bg">
        <div className="deposit-header-shadow"></div>
      </div>

      {/* Main Content */}
      <div className="deposit-main-content">
        {/* Equity Section */}
        <div className="deposit-equity-section">
          <div className="deposit-equity-label">Equity</div>
          <div className="deposit-equity-value">$10,000.00</div>
        </div>

        {/* Main Menu Buttons */}
        <div className="deposit-menu-buttons">
          <div className="deposit-menu-button" onClick={handleMenuClick}>
            <div className="deposit-menu-icon-box">
            ...
            <div className="deposit-menu-text">Menu</div>
          </div>
          <div className="deposit-menu-button" onClick={handleWithdrawalClick}>
            <div className="deposit-menu-icon-box">
            ...
            <div className="deposit-menu-text">Withdrawal</div>
          </div>
          <div className="deposit-menu-button" onClick={handleTradeClick}>
            <div className="deposit-menu-icon-box">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="deposit-menu-text">Trade</div>
          </div>
        </div>

        {/* Tab Section - Bank and Crypto */}
        <div className="mobile-deposit-tab-section">
          <button 
            className={`mobile-deposit-tab ${depositMethod === 'bank' ? 'active' : ''}`}
            onClick={() => handleDepositMethodChange('bank')}
          >
            Bank
          </button>
          <button 
            className={`mobile-deposit-tab ${depositMethod === 'crypto' ? 'active' : ''}`}
        ...
        {/* Deposit Content - Middle Section */}
        <div className="deposit-content-wrapper">
          {depositPage === 1 && (
            <div className="deposit-box">
              <div className="deposit-info-header">
                <h3 className="deposit-info-title">Deposit Information</h3>
                <p className="deposit-info-subtitle">Please enter the amount you wish to deposit:</p>
              </div>

              <div className="deposit-form-section">
                <label className="deposit-form-label">Amount to be deposited (USD)</label>
                <div className="deposit-input-group">
                  ...
                  />
                  <span className="deposit-input-unit">USD</span>
                </div>
                <p className="deposit-min-amount-text">Minimum Deposit Amount: $50 (USD)</p>
              </div>

              <div className="deposit-quick-selection">
                <span className="deposit-quick-selection-label">Quick Amount Selection</span>
                <div className="deposit-selection-buttons">
                  <button 
                    className={`deposit-selection-btn ${depositAmount === '100' ? 'active' : ''}`}
                    onClick={() => handleDepositAmountChange('100')}
                  >
                    $ 100
                  </button>
                  <button 
                    className={`deposit-selection-btn ${depositAmount === '250' ? 'active' : ''}`}
                    onClick={() => handleDepositAmountChange('250')}
                  >
                    $ 250
                  </button>
                  <button 
                    className={`deposit-selection-btn ${depositAmount === '500' ? 'active' : ''}`}
                    onClick={() => handleDepositAmountChange('500')}
                  >
                    $ 500
                  </button>
                  <button 
                    className={`deposit-selection-btn ${depositAmount === '1000' ? 'active' : ''}`}
                    onClick={() => handleDepositAmountChange('1000')}
                  >
                    $ 1000
                  </button>
                  <button 
                    className={`deposit-selection-btn ${depositAmount === '2500' ? 'active' : ''}`}
                    onClick={() => handleDepositAmountChange('2500')}
                  >
                    $ 2500
                  </button>
                </div>
              ...
              <div className="deposit-summary-section">
                <div className="deposit-summary-row">
                  <span className="deposit-summary-label">Amount to be deposited:</span>
                  <span className="deposit-summary-value">${depositAmount}.00</span>
                </div>
                <div className="deposit-summary-row">
                  <span className="deposit-summary-label">Transaction Fee:</span>
                  <span className="deposit-summary-value">$0.00</span>
                </div>
                <div className="deposit-summary-row">
                  <span className="deposit-summary-label">Commission:</span>
                  <span className="deposit-summary-value">$0.00</span>
                </div>
                <div className="deposit-summary-row deposit-total">
                  <span className="deposit-total-label">Total:</span>
                  <span className="deposit-total-value">${depositAmount}.00</span>
                </div>
              </div>
          ...
          {depositPage === 2 && depositMethod === 'bank' && (
            <div className="deposit-box">
              <div className="deposit-content">
                <div className="info-header">
                  <span className="back-icon-box" onClick={() => setDepositPage(1)}>
                ...
                <div className="important-notes">
                  <div className="notes-header" onClick={() => setIsNotesExpanded(!isNotesExpanded)}>
                    ...
                    <svg 
                      className={`notes-toggle-arrow ${isNotesExpanded ? 'expanded' : ''}`}
                      width="12" 
                      height="12" 
                      viewBox="0 0 24 24" 
                      fill="none"
          ...
          {depositPage === 3 && depositMethod === 'crypto' && (
            <div className="deposit-box">
              <div className="deposit-content">
                <div className="info-header">
                  <span className="back-icon-box" onClick={() => setDepositPage(1)}>
                ...
                <div className="crypto-form-fields">
                  <div className="form-group">
                    <label>Crypto</label>
                    <div className="crypto-select-box">
                      <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                        <div className="crypto-icon-inline">
                  ...
                  <div className="form-group">
                    ...
                    <div className="network-select-box">
                      <span>TRC 20</span>
                      <svg className="dropdown-arrow" width="12" height="12" viewBox="0 0 24 24" fill="none">
                        <path d="M6 9l6 6 6-6" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <div className="form-group">
                    ...
                    <div className="address-input-box">
                      <input 
                        type="text" 
                        placeholder="safdd9fd465afd5afda49a"
                        className="crypto-address-input"
                      />
                      <span className="copy-icon-box" onClick={() => navigator.clipboard.writeText('safdd9fd465afd5afda49a')}>
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M2.5 7.5H2C1.73478 7.5 1.48043 7.39464 1.29289 7.20711C1.10536 7.01957 1 6.76522 1 6.5V2C1 1.73478 1.10536 1.48043 1.29289 1.29289C1.48043 1.10536 1.73478 1 2 1H6.5C6.76522 1 7.01957 1.10536 7.20711 1.29289C7.39464 1.48043 7.5 1.73478 7.5 2V2.5M5.5 4.5H10C10.5523 4.5 11 4.94772 11 5.5V10C11 10.5523 10.5523 11 10 11H5.5C4.94772 11 4.5 10.5523 4.5 10V5.5C4.5 4.94772 4.94772 4.5 5.5 4.5Z" stroke="#1D6CE9" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </span>
