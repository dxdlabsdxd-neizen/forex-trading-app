            ...
            <div className="account-verification-modal" onClick={(e) => e.stopPropagation()}>
              <div className="account-verification-container">
                <div className="account-verification-header">
                  ...
                  <span className="account-verification-close" onClick={closeAccountVerification}>&times;</span>
                </div>
                  ...
                  <div className="deposit-content">
                    ...
                    <div className="crypto-selection">
                      ...
                      <div className="form-group">
                        ...
                        <div className="input-field">
                          <div style={{display: 'flex', alignItems: 'center'}}>
                            <div style={{width: '15px', height: '15px', borderRadius: '50%', backgroundColor: '#f1f1f1', marginRight: '8px'}}></div>
                            <span>TRC 20</span>
                          </div>
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.5 4.5L6 8L9.5 4.5" stroke="#777" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="input-container">
                          <input 
                            ...
                            readOnly 
                          />
                          <span className="copy-icon-box" onClick={() => navigator.clipboard.writeText('sat4d9fd465afd5afda49a')}>
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M2.5 7.5H2C1.73478 7.5 1.48043 7.39464 1.29289 7.20711C1.10536 7.01957 1 6.76522 1 6.5V2C1 1.73478 1.10536 1.48043 1.29289 1.29289C1.48043 1.10536 1.73478 1 2 1H6.5C6.76522 1 7.01957 1.10536 7.20711 1.29289C7.39464 1.48043 7.5 1.73478 7.5 2V2.5M5.5 4.5H10C10.5523 4.5 11 4.94772 11 5.5V10C11 10.5523 10.5523 11 10 11H5.5C4.94772 11 4.5 10.5523 4.5 10V5.5C4.5 4.94772 4.94772 4.5 5.5 4.5Z" stroke="#1D6CE9" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                          </span>
          ...
          <div className="order-panel-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="order-panel-header">
              <div className="pair-selector-container">
                <svg className="pair-selector-icon" width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                ...
                <svg className="pair-selector-arrow" width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="order-panel-tabs">
              ...
              >
                <svg className="tab-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Account Statistics Modal */}
          <div className="alert-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="alert-header">
              ...
              <button className="alert-close" onClick={closeSetAlertModal}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>
                </svg>
              </button>
            ...
            <div className="alert-tabs-container">
              <div className="alert-tabs">
                <div 
                  className={`alert-tab ${alertActiveTab === 'Set Alert' ? 'active' : ''}`}
                  onClick={() => setAlertActiveTab('Set Alert')}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div 
                  className={`alert-tab ${alertActiveTab === 'Added Alerts' ? 'active' : ''}`}
                  onClick={() => setAlertActiveTab('Added Alerts')}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/>
                  </svg>
            ...
            <div className="alert-content">
              {alertActiveTab === 'Set Alert' && (
                <div className="set-alert-content">
                  <h2 className="alert-title">Create New Price Alert</h2>
                  <p className="alert-description">Set price alerts for your favorite instrument to get notified when prices reach your target levels</p>
                  
                  {/* Instrument Selection */}
                  <div className="alert-field">
                    <label className="alert-label">instrument</label>
                    <div className="alert-input-container">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="alert-input-icon">
                        <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"/>
                      </svg>
                      <span className="alert-input-text">{selectedInstrument}</span>
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="alert-dropdown-icon">
                        <path d="M7 10l5 5 5-5z"/>
                      </svg>
                    </div>
                  </div>
                  ...
                  {/* Price Level */}
                  <div className="alert-field">
                    <label className="alert-label">Price Level</label>
                    <input 
                      type="text" 
                  ...
                  <div className="alert-field">
                    ...
                    <div className="alert-options">
                      <button 
                        className={`alert-option ${condition === 'ABOVE' ? 'active above' : ''}`}
                        onClick={() => setCondition('ABOVE')}
                      >
                        ABOVE
                      </button>
                      <button 
                        className={`alert-option ${condition === 'EQUAL' ? 'active equal' : ''}`}
                        onClick={() => setCondition('EQUAL')}
                      >
                        EQUAL
                      </button>
                      <button 
                        className={`alert-option ${condition === 'BELOW' ? 'active below' : ''}`}
                  ...
                  {/* Notification Type */}
                  <div className="alert-field">
                    <label className="alert-label">Notification Type</label>
                    <div className="alert-options">
                      <button 
                        className={`alert-option ${notificationType === 'POP-UP' ? 'active popup' : ''}`}
                        onClick={() => setNotificationType('POP-UP')}
                      >
                        POP-UP
                      </button>
                      <button 
                        className={`alert-option ${notificationType === 'E-MAIL' ? 'active email' : ''}`}
              ...
              {alertActiveTab === 'Added Alerts' && (
                <div className="added-alerts-content">
                  <div className="alerts-header">
                    <div>
                      <h3 className="alerts-title">Your Active Alerts</h3>
                      <p className="alerts-description">Manage and monitor your price alert. You can activate, deactivate or delete alerts as needed.</p>
                    </div>

                  </div>

                  <div className="alerts-instrument">
                    <label className="alert-label">instrument</label>
                  </div>
                  ...
                  <div className="alert-items">
                    <div className="alert-item">
                      <div className="alert-item-left">
                        ...
                        <div className="alert-info">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="alert-chart-icon">
                            <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"/>
                          </svg>
                          <div className="alert-details">
                            <span className="alert-instrument">CADCHF</span>
                            <span className="alert-condition">&gt; 1.08450</span>
                          </div>
                        </div>
                      </div>
                      <div className="alert-actions">
                        <button className="alert-action deactivate">Deactivate</button>
                    ...
                    <div className="alert-item">
                      <div className="alert-item-left">
                        <div className="alert-status inactive">
                          <div className="status-dot red"></div>
                          <span>Inactive</span>
                        </div>
                        <div className="alert-info">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="alert-chart-icon red">
                            <path d="M16 18l-2.29-2.29 4.88-4.88 4 4L22 7.41 20.59 6l-6 6-4-4-6.3 6.29L2 12v6z"/>
                          </svg>
                          <div className="alert-details">
                            <span className="alert-instrument">CADCHF</span>
                            <span className="alert-condition">&gt; 1.08450</span>
                      ...
                      <div className="alert-actions">
                        <button className="alert-action activate">Activate</button>
                        <button className="alert-delete">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
                          </svg>
        ...
        <div className="help-desk-overlay" onClick={closeHelpDeskModal}>
          <div className="help-desk-modal" onClick={(e) => e.stopPropagation()}>
            <div className="help-desk-header">
              ...
              <span className="help-desk-close-btn" onClick={closeHelpDeskModal}>&times;</span>
            </div>
